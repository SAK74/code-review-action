...
var import_provider_utils5 = __nccwpck_require__(746);

// src/openai-chat-language-model.ts
var import_provider2 = __nccwpck_require__(466);
var import_provider_utils3 = __nccwpck_require__(746);
var import_zod2 = __nccwpck_require__(809);

// src/convert-to-openai-chat-messages.ts
var import_provider = __nccwpck_require__(466);
var import_provider_utils = __nccwpck_require__(746);
...
// src/openai-error.ts
var import_zod = __nccwpck_require__(809);
var import_provider_utils2 = __nccwpck_require__(746);
...
var import_provider4 = __nccwpck_require__(466);
var import_provider_utils4 = __nccwpck_require__(746);
var import_zod3 = __nccwpck_require__(809);

// src/convert-to-openai-completion-prompt.ts
var import_provider3 = __nccwpck_require__(466);
...
var import_provider_utils7 = __nccwpck_require__(746);

// src/openai-embedding-model.ts
var import_provider5 = __nccwpck_require__(466);
var import_provider_utils6 = __nccwpck_require__(746);
var import_zod4 = __nccwpck_require__(809);
...
// src/generate-id.ts
var import_non_secure = __nccwpck_require__(910);
...
// src/parse-json.ts
var import_provider4 = __nccwpck_require__(466);
var import_secure_json_parse = __toESM(__nccwpck_require__(84));
...
var import_provider6 = __nccwpck_require__(466);
var import_stream = __nccwpck_require__(201);
...
const util_1 = __nccwpck_require__(771);
...
const en_1 = __importDefault(__nccwpck_require__(294));
...
__exportStar(__nccwpck_require__(640), exports);
__exportStar(__nccwpck_require__(935), exports);
__exportStar(__nccwpck_require__(771), exports);
__exportStar(__nccwpck_require__(128), exports);
...
const errors_1 = __nccwpck_require__(918);
const en_1 = __importDefault(__nccwpck_require__(294));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.z = void 0;
const z = __importStar(__nccwpck_require__(365));
exports.z = z;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const util_1 = __nccwpck_require__(771);
const ZodError_1 = __nccwpck_require__(176);
...
const parseUtil_1 = __nccwpck_require__(640);
const util_1 = __nccwpck_require__(771);
const ZodError_1 = __nccwpck_require__(176);
...
const openai_1 = __nccwpck_require__(635);
const node_fs_1 = __nccwpck_require__(24);
const assistant_description_1 = __importDefault(__nccwpck_require__(962));
const prompt_1 = __importDefault(__nccwpck_require__(727));
// import "dotenv/config";
const OPENAI_API_KEY = process.env.OPENAI_API_KEY;
// const OPENAI_API_KEY = getInput('OPENAI_API_KEY');
function main(diffFileURL) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const modelOpenAI = (0, openai_1.openai)("gpt-4o-mini");
        // const modelAnthropic = anthropic("claude-3-haiku-20240307");
        let diffContent;
        try {
            if (!(0, node_fs_1.existsSync)(diffFileURL)) {
                throw Error("Path doesn't exist");
            }
            diffContent = (0, node_fs_1.readFileSync)(diffFileURL).toString("utf-8");
        }
        catch (err) {
        ...
        console.log({ assistantDescription: assistant_description_1.default, prompt: prompt_1.default });
...
const node_https_1 = __nccwpck_require__(708);
const node_fs_1 = __nccwpck_require__(24);
function fetchWithRedirect(url, pathToFile, resolve, reject, redirectCount = 0) {
    if (redirectCount > 2) {
    ...
    (0, node_https_1.get)(url, (resp) => {
        ...
        if (resp.statusCode === 302 && resp.headers.location) {
            fetchWithRedirect(resp.headers.location, pathToFile, resolve, reject, redirectCount + 1);
            return;
        }
        const writeStream = (0, node_fs_1.createWriteStream)(pathToFile).on("finish", () => {
            resolve();
        });
...
function getDiffContent(pathToFile) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports["default"] = `You are experienced full stack developer. Be precise when answering and avoid long introductions.`;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports["default"] = `Conduct Code Review of the git diff attached in the following file.
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const aiClient_1 = __importDefault(__nccwpck_require__(366));
const getDiff_1 = __nccwpck_require__(300);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            yield (0, getDiff_1.getDiffContent)(diffPath);
            console.log("Diff file was created");
            const review = yield (0, aiClient_1.default)(diffPath);
...
var index = __nccwpck_require__(107);
